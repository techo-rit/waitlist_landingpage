...
export const WaitlistModal: React.FC<WaitlistModalProps> = ({ isOpen, onClose, onSignupSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
      ...
      {/* Modal Content */}
      <div className="relative bg-[#0a0a0a] border border-white/10 rounded-3xl w-full max-w-lg p-8 shadow-2xl shadow-brand-900/20 animate-in zoom-in-95 duration-200">
        <button 
          onClick={onClose}
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-white mb-2">Join the Innercircle</h2>
